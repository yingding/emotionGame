...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'librealsense' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sebtut/catkin_ws/install/${idir}'.  Ask the maintainer 'Sergey Dorodnicov <sergey.dorodnicov@intel.com>, Mark Horn <mark.d.horn@intel.com>, Reagan Lopez <reagan.lopez@intel.com>' to fix it.")
    endif()
